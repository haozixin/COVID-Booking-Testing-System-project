...
public class SearchSiteController extends Controller {
    ...
    class filterListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            tempFilteredData1 = dataModel.filterByOnFactor(Site.SUBURB_FIELD,suburbValue);
            tempFilteredData2 = dataModel.filterByOnFactor(Site.FACILITY_TYPE_FIELD,facilityTypeValue);
